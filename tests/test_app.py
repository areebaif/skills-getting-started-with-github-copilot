...
def test_unregister_from_activity_succeeds_for_signed_up_student():
    # Arrange
    client = TestClient(app)
...
def test_unregister_from_activity_returns_400_when_student_not_signed_up():
    # Arrange
    client = TestClient(app)
